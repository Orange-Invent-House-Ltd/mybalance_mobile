  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ExpansionTile(
        ...
        textColor: AppColors.g200,
        iconColor: AppColors.g200,
        collapsedTextColor: AppColors.g200,
        collapsedIconColor: AppColors.g200,
        childrenPadding: const EdgeInsets.fromLTRB(11, 0, 36, 13),
        children: [
          Text(
